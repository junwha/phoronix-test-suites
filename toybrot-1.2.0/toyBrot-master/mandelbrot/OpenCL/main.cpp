...
int runProgram(bool benching) noexcept
{
    ...
    FracGen gpuFrac(benching, requestCPU, requestVendor);
...
void printUsage()
{
    std::vector<std::string> help
    {
        ...
        "    -c",
        "        Ask for a CPU OpenCL device",
        "    -a",
        "        Ask for an AMD device",
        "    -n",
        "        Ask for an nVidia device",
        "    -t",
        "        Ask for an intel device"
...
int main (int argc, char** argv) noexcept
{
    ...
    enum class setting{NONE, ITERATIONS, OUTPUT, CPU, INTEL, NVIDIA, AMD};
