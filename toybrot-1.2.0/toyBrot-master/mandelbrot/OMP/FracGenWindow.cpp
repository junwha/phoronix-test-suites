     ...
     exitNow{exit}
{
    ...
    mainwindow = SDL_CreateWindow("OpenMP Toybrot - Use Mouse1 to zoom in and Mouse2 to zoom out",
    ...
    texture = SDL_CreateTexture(    render,
                                    ...
                                    width, height);
    SDL_SetWindowTitle(mainwindow, "OpenMP Toybrot - Use Mouse1 to zoom in and Mouse2 to zoom out");
