     ...
     exitNow{exit}
{
    ...
    mainwindow = SDL_CreateWindow("CUDA Toybrot - Use Mouse1 to zoom in and Mouse2 to zoom out. Press Mouse 3 to change colouring scheme",
    ...
    texture = SDL_CreateTexture(    render,
                                    ...
                                    width, height);
    SDL_SetWindowTitle(mainwindow, "CUDA Toybrot - Use Mouse1 to zoom in and Mouse2 to zoom out. Press Mouse 3 to change colouring scheme");
