...
#include "FracGen.hpp"
    ...
    #if TOYBROT_OPENMP_DIST
        static std::string flavourName = "OpenMP-dist-db";
        static std::string fileName    = "openmp-dist-db.c";
    #else
        static std::string flavourName = "OpenMP-db";
        static std::string fileName    = "openmp-db.c";
    #endif
#else
    #if TOYBROT_OPENMP_DIST
        static std::string flavourName = "OpenMP-dist";
        static std::string fileName    = "openmp-dist.c";
    #else
        static std::string flavourName = "OpenMP";
        static std::string fileName    = "openmp.c";
    #endif
#endif
...
static constexpr const int32_t  hueOffset   = 365;
