...
#include "FracGen.hpp"
    ...
    static std::string flavourName = "OpenGL-frag-db";
    static std::string fileName    = "opengl-frag-db.c";
#else
    static std::string flavourName = "OpenGL-frag";
    static std::string fileName    = "opengl-frag.c";
#endif
