...
#include "FracGen.hpp"
    ...
    static std::string flavourName = "HIP-db";
    static std::string fileName    = "hip-db.c";
#else
    static std::string flavourName = "HIP";
    static std::string fileName    = "hip.c";
#endif
...
static constexpr const tbFPType hueFactor   = -40.0;
static constexpr const int32_t  hueOffset   = 245;
