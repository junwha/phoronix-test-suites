...
#include "FracGen.hpp"
    ...
    static std::string flavourName = "OpenGL-db";
    static std::string fileName    = "opengl-db.c";
#else
    static std::string flavourName = "OpenGL";
    static std::string fileName    = "opengl.c";
#endif
...
static constexpr const tbFPType bgRed       = 0.25;
static constexpr const tbFPType bgGreen     = 0.05;
static constexpr const tbFPType bgBlue      = 0.15;
...
int main (int argc, char** argv) noexcept
{
    ...
    enum class setting{NONE, ITERATIONS, DIMENSIONS, HEADLESS, OUTPUT, EXPORT};
    uint8_t dimSet = 0;
    uint8_t devSet = 0;
