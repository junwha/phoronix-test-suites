...
#include "FracGen.hpp"
    ...
    static std::string flavourName = "STD::TASKS-db";
    static std::string fileName    = "std_tasks-db.c";
#else
    static std::string flavourName = "STD::TASKS";
    static std::string fileName    = "std_tasks.c";
#endif
