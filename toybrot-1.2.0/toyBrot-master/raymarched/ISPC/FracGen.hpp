...
enum class LoopMode {FOREACH = 0, TILED = 1, STRIDED = 2};
...
public:
    ...
    FracGen(bool bench = false, CameraPtr c = nullptr, ParamPtr p = nullptr, LoopMode mode = LoopMode::TILED, size_t threadMulti = 20);
    ~FracGen();
