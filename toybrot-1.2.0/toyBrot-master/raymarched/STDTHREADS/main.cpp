...
#include "FracGen.hpp"
    ...
    static std::string flavourName = "STD::THREADS-db";
    static std::string fileName    = "std_threads-db.c";
#else
    static std::string flavourName = "STD::THREADS";
    static std::string fileName    = "std_threads.c";
#endif
