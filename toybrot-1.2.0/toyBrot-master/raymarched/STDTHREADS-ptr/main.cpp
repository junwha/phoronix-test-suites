...
#include "FracGen.hpp"
    ...
    static std::string flavourName = "STD::THREADS-ptr-db";
    static std::string fileName    = "std_threads-ptr-db.c";
#else
    static std::string flavourName = "STD::THREADS-ptr";
    static std::string fileName    = "std_threads-ptr.c";
#endif
