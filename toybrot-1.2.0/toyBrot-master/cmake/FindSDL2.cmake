...
set(SDL2_LIBRARY ${SDL2_LIBRARY} CACHE STRING "Where the SDL Library can be found")
...
if(SDL2_LIBRARY)
  ...
  if(SDL2MAIN_LIBRARY AND NOT SDL2_BUILDING_LIBRARY)
    list(FIND SDL2_LIBRARY "${SDLMAIN_LIBRARY}" _SDL2_MAIN_INDEX)
  ...
  if(APPLE)
    target_link_libraries(SDL2::SDL2 "-framework Cocoa")
  endif()
...
set(SDL2_LIBRARIES ${SDL2_LIBRARY} ${SDL2MAIN_LIBRARY} ${SDL2_LIBRARY_TEMP})
