 ...
 *   rendering engine.                                            
 *
 * $Id: tachyon.h,v 1.136 2021/12/11 03:44:56 johns Exp $
 *
 */
 ...
 */
#define TACHYON_VERSION_STRING      "0.99.2"  /**< string version info  */
#define TACHYON_MAJOR_VERSION       0         /**< major version number */
#define TACHYON_MINOR_VERSION       99        /**< minor version number */
#define TACHYON_PATCH_VERSION       2         /**< patch version number */
...
/** Backwards compatibility with older revs of Tachyon that provided convenience */
/** emulation wrappers for parallel runs on the Intel iPSC/860 NX OS             */
int rt_mynode(void);
 ...
 * 1. resets and initializes the raytracing system (and MPI!)
...
#define RT_PROJECTION_EQUIRECTANGULAR  3  /**< 360 lat-long equirectangular */
#define RT_PROJECTION_FISHEYE          4  /**< Fisheye projection mode      */
#define RT_PROJECTION_STEREO_EQUIRECTANGULAR  5  /**< over/under omnistereo equirectangular */
...
/*
 * macro for unlimited AO occlusion distance
 */
