...
BEGIN {
    ...
    require '/var/lib/phoronix-test-suite/installed-tests/pts/openssl-3.0.1/openssl-openssl-3.0.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/var/lib/phoronix-test-suite/installed-tests/pts/openssl-3.0.1/openssl-openssl-3.0.0/test/fips-and-base.cnf';
    shift;
